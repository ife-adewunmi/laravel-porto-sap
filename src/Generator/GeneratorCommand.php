...
use Iadewunmi\PortoSap\Generator\Traits\FileSystemTrait;
use Iadewunmi\PortoSap\Generator\Traits\FormatterTrait;
use Iadewunmi\PortoSap\Generator\Traits\ParserTrait;
use Iadewunmi\PortoSap\Generator\Traits\PrinterTrait;
...
abstract class GeneratorCommand extends LaravelCommand implements ComponentsGenerator
{
    use ParserTrait;
    use PrinterTrait;
    use FileSystemTrait;
     ...
     * @var string
     */
    protected const DEFAULT_SECTION_NAME = 'Main';
    ...
    private function validateGenerator($generator): void
    {
        if (!$generator instanceof ComponentsGenerator) {
            throw new Exception('Your component maker command should implement ComponentsGenerator contract.');
        }
    }
     ...
     */
    protected function sanitizeUserData($data): mixed
    {
